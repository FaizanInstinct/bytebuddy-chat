    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-800 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Welcome to ByteBuddy</h1>
          <p className="text-gray-600 dark:text-gray-300">Sign in to save your conversations</p>
        </div>
        
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-green-100 dark:border-green-800">
          <SignIn 
            appearance={{
              elements: {
